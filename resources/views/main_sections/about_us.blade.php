...
@section('content')
<section>
    <div class="container" id='step2_other_menu'>
        <div class="row mt-3">
            ...
            <div class="col-md-2">
                <div class="input-group pl-1" style="width: max-content; max-width: 120px;">
                    <span class="input-group-btn">
                        <button type="button" class="btn btn-default btn-number" disabled="disabled" data-type="minus" data-field="quant[6]">
                            <span class="fas fa-minus"></span>
                        </button>
                    </span>
                    <input type="text" name="quant[6]" id="counterMonths" class="form-control input-number" value="1" min="1" max="12">
                    <span class="input-group-btn">
            ...
            <div class="col-md-1 font-weight-bold my-auto m-0 p-0">
                Meses
            </div>
            <div class="col-md-2">
