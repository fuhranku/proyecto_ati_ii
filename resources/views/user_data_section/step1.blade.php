    ...
    <form id='form-step-1'>
        ...
        <div class="container justify-content-center">
            <div class='row mt-3'>
                ...
                <div class='col-sm-2'>
                    <input type="checkbox" class="form-check-input" id="checkbox-natural" name='person_type' value="nat">
                    <label class="form-check-label" for="natural" >Persona natural</label>
                </div>
                <div class='col-sm-2'>
                    <input type="checkbox" class="form-check-input" id="checkbox-juridica" name='person_type' value="jur">
