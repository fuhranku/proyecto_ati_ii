            ...
            <div class="row m-3">
                ...
                <div class="form-group col-md-4">
                    <div class="form-check">
                        <input class="form-check-input radio-btn-video-publish" type="radio" name="radio-btn-video" value=1>
                ...
                <div class="form-group col-md-4">
                    <div class="form-check">
                        <input class="form-check-input radio-btn-video-publish" type="radio" name="radio-btn-video" value=0>
                        <label class="form-check-label sm-text">
                          No
                        </label>
                    </div>
