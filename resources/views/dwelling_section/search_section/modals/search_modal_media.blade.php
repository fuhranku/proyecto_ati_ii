        ...
        <div class="w-40 mx-auto bg-white pb-3 modal-border" >
            ...
            <div class="container pt-1 pr-4 pl-4">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="text-uppercase text-underline text-blue font-weight-bold">Apartamento</div>
                        <div class="text-uppercase text-underline text-red font-weight-bold">Venta</div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-7">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-12">
                                <u class="d-inline"><strong>País</u>: </strong><p class="m-0 d-inline">Venezuela</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <u class="d-inline"><strong>Estado</u>: </strong><p class="m-0 d-inline">Distrito Capital</p>
                            </div>
                        </div>
                    </div>
                </div>
