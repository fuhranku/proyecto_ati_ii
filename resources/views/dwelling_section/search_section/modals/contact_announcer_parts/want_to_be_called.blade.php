<div class='d-none contact-announcer-section' id="section-2">
    ...
    <div class="container mr-5">
        ...
        <div class="row">
            ...
            <div class="col-md-7 ">
                <input class='sm-text w-100 pl-1' type="text" placeholder="John" name='section-2-applicant-name'>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5 pr-0">
            ...
            <div class="col-md-7">
                <input class='sm-text w-100 pl-1' type="text" placeholder="Doe" name='section-2-applicant-lastname'>
            </div>
        </div>
        <div class="row mt-2">
        ...
        <div class="row text-center mb-3">
            <div class="col-sm-12 mt-2 pl-2 pr-2">
                <a class="btn btn-yellow text-center post-contact-announcer-btn mt-2 md-text" style='padding: 0px 15px;' href="#" data-section-id=2 >Contactar al anunciante</a>
            </div>
        </div>
</div>
