    ...
    <div class="row p-2">
        ...
        <div class="col-md-8">
            <div class="input-group" style="width: max-content; max-width: 120px;">
                ...
                <input type="text" name="quant[1]" id="counterRoom" class="form-control input-number" value={{$dwelling['rooms']}} min="1" max="10">
                <span class="input-group-btn">
    ...
    <div class="row p-2">
        ...
        <div class="col-md-8">
            <div class="input-group" style="width: max-content; max-width: 120px;">
                ...
                <input type="text" name="quant[2]" id="counterBath" class="form-control input-number" value={{$dwelling['bathrooms']}} min="1" max="10">
                <span class="input-group-btn">
    ...
    <div class="row p-2">
        ...
        <div class="col-md-8">
            <div class="input-group" style="width: max-content; max-width: 120px;">
                ...
                <input type="text" name="quant[3]" id="counterPark" class="form-control input-number" value={{$dwelling['parking']}} min="1" max="10">
                <span class="input-group-btn">
