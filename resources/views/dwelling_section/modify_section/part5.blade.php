        ...
        <div class="row">
            <div class="col-md 12 border border-primary mt-1 p-3">
                <div class="row mt-3 mr-3 ml-3">
                    ...
                    <div class="col-md-6">
                    <input type="text" class="form-control input-section2" id="name-contact-publish-dwelling-input" value="{{$dwelling['contact_name']}}">
                    </div>
                </div>
                ...
                <div class="row mt-3 mr-3 ml-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control input-section2" id="lastname-contact-publish-dwelling-input" value="{{$dwelling['contact_lastname']}}">
                    </div>
                </div>
                @component('components.field_error')
                    @slot('grid_size')
                ...
                <div class="row mt-3 mr-3 ml-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control input-section2" id="email-contact-publish-dwelling-input" value="{{$dwelling['contact_email']}}">
                    </div>
                </div>
